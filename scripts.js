document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function loadData() {
        try {
            ...
            // Update the wordCountElement with the Oops message in red and apply font family
            wordCountElement.innerHTML = '<span style="color: #dc3545; font-family: Tahoma, -apple-system, \'Helvetica Neue\', Helvetica, Roboto, sans-serif;">Oops!</span>';

            // Disable and make the search box semi-transparent
            const searchBox = document.querySelector('.search-box');
            searchBox.classList.add('disabled');  // Add the 'disabled' class to the search box
        }
    }
